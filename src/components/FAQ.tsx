...
const faqs = [
  ...
  },
  {
    ...
    a: "Our scoring combines objective metrics (Lighthouse data, DOM analysis) with AI evaluation. Performance and SEO scores are based on industry-standard tools. Design and copy scores use advanced AI vision, calibrated against thousands of high-converting landing pages.",
  },
];
